...
import './walletTablealltransaction.scss';
...
const WalletTableAllTransaction = () => {
  return (
    <Box >
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="left"><div  className={row.amount.includes("-") ? "amountNegative" : "amountPositive"} 
               >{row.amount}</div></TableCell>
...
export default WalletTableAllTransaction