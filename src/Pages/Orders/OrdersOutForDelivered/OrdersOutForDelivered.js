...
import "./ordersOutFordelivered.scss"
...
const styleDeliveryStatusStepperModal = {
  position: 'absolute',
  top: '50%',
  left: '50%',
  transform: 'translate(-50%, -50%)',
...
const steps = [
  {
    ...
    description:'14 Feb 2022 | 8:20 am',
...
const rows = [
    createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Out for delivery"),
    createData('Apple', "Jewelry", "This is jewelry", '24$',9, '27/02/2023', "Out for delivery"),
    createData('Lab Earrings', "Jewelry", "This is jewelry", '24$',9, '27/02/2023', "Out for delivery"),
    createData('Lab Earrings', "Jewelry", "This is jewelry", '24$',9, '27/02/2023', "Out for delivery"),
    createData('Lab Earrings', "Jewelry", "This is jewelry", '24$',9, '27/02/2023', "Out for delivery"),
    createData('Lab Earrings', "Jewelry", "This is jewelry", '24$',9, '27/02/2023', "Out for delivery"),
...
const Ordertable = () => {
  ...
  const [openstyleDeliveryStatusStepperModal, setOpenstyleDeliveryStatusStepperModal] = React.useState(false);
  const handleOpenstyleDeliveryStatusStepperModal = () => setOpenstyleDeliveryStatusStepperModal(true);
  const handleClosestyleDeliveryStatusStepperModal = () => setOpenstyleDeliveryStatusStepperModal(false);
  ...
  return (
          ...
          <Box sx={style}>
            <Box>
              ...
              <Box className="modalWrapper">
                <Box className="orderFlex">
                  <p className='orderDetails'>Order Details</p>
                  <Box className="btnFlex">
                    <p className='statusTxt'>Status</p>
                    <Button className='outForDeliveryBtn'>Out for delivery</Button>
                  </Box>
                ...
                < Box className="orderDetailWrapper">
                  ...
                  <Box className="iconFlex">
                    <img src={ ordericon } className='icon' />
                ...
                <Box className="btnFlex">
                  <Button onClick={handleOpenstyleDeliveryStatusStepperModal} className='checkStatus'>Check Status</Button>
    ...
    <div>
      ...
      >
        <Box sx={styleCancellationModal}>
          ...
          <Box className="requestingCancellationWrapper">
    ...
    <div>
      ...
      >
        ...
        <Box className="requestingCancellationWrapperOutForDelivery">
          <Box className="iconFlex">
    ...
    <div>
      ...
      <Modal
        open={openstyleDeliveryStatusStepperModal}
        onClose={handleClosestyleDeliveryStatusStepperModal}
        aria-labelledby="modal-modal-title"
        aria-describedby="modal-modal-description"
      >
        <Box sx={styleDeliveryStatusStepperModal}>
          <Box  className="DeliveryStatusFlexWrapper">
          <Box className="DeliveryStatusFlex">
            <p  className='deliveryStatusHeading'>Delivery status</p>
            <img onClick={handleClosestyleDeliveryStatusStepperModal} className='icon' src={crossIcon} />
            </Box>
            
            <p className='deliveryStatusDiscription'>Delivery method: Deliver to home country</p>
      ...
      <Stepper activeStep={activeStep} orientation="vertical">
        {steps.map((step, index) => (
          <Step style={{display:"flex", alignItems:"center",justifyContent:"space-between"}} key={step.label}>
            <StepLabel
              optional={
                index === 2 ? (
          ...
          <TableBody>
            {rows.map((row, index) => (
              ...
              <TableCell align="left">{row.name}</TableCell>
                ...
                <TableCell align="left"  ><div className='statusOutForDelivery'>{row.status}</div></TableCell>
