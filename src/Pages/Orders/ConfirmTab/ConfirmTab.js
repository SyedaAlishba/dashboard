...
import UpdatesOrders from './UpdateOrders/UpdatesOrders';
...
const rows = [
  createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
  createData('Apple', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
  createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
  createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
  createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
  createData('Lab Earrings', "Jewelry", "This is jewelry", '24$', 9, '27/02/2023', "Comfirmed"),
...
const Ordertable = () => {
  ...
  const [flagUpdateOrders, setFlagUpdateOders] = React.useState(false);
              ...
              <Box className="modalWrapper">
                <Box className="orderFlex">
                  ...
                  <Box className="btnFlex">
                    ...
                    <Button className='comfirmedBtn'>Confirmed</Button>
                  </Box>
                ...
                <Box className="btnFlex">
                  <Button onClick={(e) => {
                    setFlagUpdateOders(true)
                    handleClose()
                  }} className='fulfilOrder'>Update Order</Button>
          ...
          <Box sx={styleCancellationModal}>
            ...
            <Box className="requestingCancellationWrapper">
              <Box className="crossIconFlex">
                ...
                <img className='iconStyle' src={{ crossIcon }} />
              </Box>
              <hr
                style={{
                  background: '#EDEAFB',
          ...
          <TableBody>
            {rows.map((row, index) => (
              ...
              >
                ...
                <TableCell align="left"  ><div className='statusComfirmed'>{row.status}</div></TableCell>
